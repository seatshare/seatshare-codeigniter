...
<?php echo form_open('', array('role'=>'form', 'class' => 'form-horizontal')); ?>
	<div class="form-group">
		<?php echo form_label('Ticket Purchaser', 'owner', array('class'=>'col-lg-3 control-label')); ?>
		<div class="col-lg-9">
			<?php echo form_input(array('name'=>'owner', 'class'=>'form-control', 'disabled'=>true, 'value'=>$ticket->owner->name)); ?>
		</div>
	</div>
	<div class="form-group">
...
<?php echo form_open('tickets/request/' . $ticket->ticket_id, array('role'=>'form', 'class' => 'form-horizontal')); ?>
	<div class="form-group">
		<?php echo form_label('Ticket Holder', 'owner', array('class'=>'col-lg-3 control-label')); ?>
		<div class="col-lg-9">
			<?php echo form_input(array('name'=>'owner', 'class'=>'form-control', 'disabled'=>true, 'value'=>$ticket->owner->name)); ?>
		</div>
	</div>
	<div class="form-group">
		<?php echo form_label('Assigned To', 'assigned', array('class'=>'col-lg-3 control-label')); ?>
		<div class="col-lg-9">
			<?php echo form_input(array('name'=>'assigned', 'class'=>'form-control', 'disabled'=>true, 'value'=>($ticket->assigned) ? $ticket->assigned->name : 'Unassigned')); ?>
		</div>
	</div>
	<div class="form-group">
		<?php echo form_label('Cost', 'assigned', array('class'=>'col-lg-3 control-label')); ?>
		<div class="col-lg-9">
			<?php echo form_input(array('name'=>'cost', 'class'=>'form-control', 'disabled'=>true, 'value'=>number_format($ticket->cost,2))); ?>
		</div>
	</div>
